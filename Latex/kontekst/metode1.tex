...
\section{Evaluering}
***Forklar om testen der vælges*** \\
Systemets anvendelighed er evalueret i forhold til performance og brugbarhed af medarbejdere fra SRN, som har kendskab til risikovurdering af lægemiddelskift. En introduktion til systemet blev givet inden evalueringen for at sikre at formålet med evaluering og hvordan denne skulle foregå var forstået, denne fremgår af Appendiks \ref{App:Intro}.

Systemets performance er testet ved at sammenligne Lægemiddel Nyt med medarbejdernes vurdering af lægemiddelskift i forhold til, hvornår der kræves uddybende information til klinikken. Medarbejderne vurderede 33 lægemiddelskift udvalgt fra skift i år 2016, 2017 og 2018, hvilket fremgår af Appendiks~\ref{App:Evaluering}. Disse er udvalgt på baggrund af risikoscore og begrundelse i forhold til at repræsentere forskellige lægemiddelskift. \textcolor{red}{Efterfølgende er sammenligningen mellem vurderingerne foretaget af medarbejdere fra SRN og Lægemiddel Nyt testet ved chi-squared test.}
