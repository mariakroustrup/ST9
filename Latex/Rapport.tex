...
%SKAL INDSÆTTES\cleardoublepage												% Indsaetter tom side, saa naeste kapitel starter paa hoejre side (hvis noedvendigt)
%\include{formalia/titelblad}
%\include{formalia/abstract}
%SKAL INDSÆTTES\cleardoublepage
...
%SKAL INDSÆTTES\listoffixmes													% Fixme-listen - fjernes til sidst i projektet med "%"
